...
<body>
  <div class="ccontainer-fluid">
    <div class="row">
      ...
      <div class="col-md-4 border border-primary mt-3">
        <div class="ml-5">
         ...
         <form action="index.php"  method="post">
          <div class="form-group form-inline">
            ...
            <input type="text" name="ukdoyuncu" id="ukdoyuncu" class="form-control ml-1 border border-primary" placeholder="oyuncu ukd giriniz" value="<?php echo $goukd; ?>">
          </div>
          <div class="form-group form-inline">
            <label class="form-control-label" for="ukdrakip"><b>Rakip UKD&nbsp;&nbsp;&nbsp;&nbsp;:</b></label>
            <input type="text" name="ukdrakip" id="ukdrakip" class="form-control ml-1 border border-primary" placeholder="Rakip ukd giriniz" value="<?php echo $grukd;?>">
          </div>
